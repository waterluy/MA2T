...
if __name__ == '__main__':
    ...
    parser.add_argument('--predroot', default='./test/base_e2e/now.pkl', help='Path to results.pkl')
    parser.add_argument('--out_folder', default='./test/base_e2e/now/vis', help='Output folder path')
    parser.add_argument('--demo_video', default='now.avi', help='Demo video name')
