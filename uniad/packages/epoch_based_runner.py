        ...
        for i, data_batch in enumerate(self.data_loader):
            ...
            if 0 == i % 100:
                if self.model.module.dynamic == 'ma2t':
                    ...
                    self.ma2t_history_task_loss['past1'] = np.array([self.outputs['log_vars']['track.loss'], 
                                                                    self.outputs['log_vars']['map.loss'],
                                                                    self.outputs['log_vars']['motion.loss'],
                                                                    self.outputs['log_vars']['occ.loss'],
                                                                    self.outputs['log_vars']['planning.loss']], dtype=np.float32)       
