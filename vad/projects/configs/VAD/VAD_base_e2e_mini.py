...
map_ann_file = 'data/nuscenes_mini_map_anns_val.json'
...
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=0,  # 原来是4   否则会卡住结束不了。。。。。。
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='data/vad_nuscenes_mini_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             pc_range=point_cloud_range,
             ann_file='data/vad_nuscenes_mini_infos_temporal_val.pkl',
